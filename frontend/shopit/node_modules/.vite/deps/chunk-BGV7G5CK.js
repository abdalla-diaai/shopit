...
} from "./chunk-UGA62SRT.js";
import {
  contains,
  useIsomorphicEffect_default as useIsomorphicEffect_default2,
  useWindow
} from "./chunk-P6FTHA7R.js";
import {
  dataAttr,
  qsa
...
} from "./chunk-5ZQ5YMKX.js";
import {
  divWithClassName_default
} from "./chunk-KQPB2YKH.js";
import {
  canUseDOM_default,
  listen_default,
  ownerDocument,
  useEventCallback
} from "./chunk-7MSBGTR7.js";
import {
  useEventCallback as useEventCallback2,
  useIsomorphicEffect_default,
  useMounted,
  usePrevious
} from "./chunk-ONDIE6JY.js";
import {
  useBootstrapPrefix
} from "./chunk-YX7YRXUK.js";
import {
  require_classnames
...
function useRTGTransitionProps(_ref) {
  ...
  return Object.assign({}, props, {
    ...
    ) : (0, import_react7.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var OffcanvasToggling = React5.forwardRef(({
  ...
  return (0, import_jsx_runtime5.jsx)(TransitionWrapper_default, {
    ...
    children: (status, innerProps) => React5.cloneElement(children, {
      ...innerProps,
      className: (0, import_classnames2.default)(className, children.props.className, (status === ENTERING || status === EXITING) && `${bsPrefix}-toggling`, transitionStyles[status])
    })
  });
});
...
var ModalContext = React6.createContext({
...
var OffcanvasHeader = React8.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var OffcanvasTitle = React9.forwardRef(({
  className,
  bsPrefix,
...
function DialogTransition(props) {
  return (0, import_jsx_runtime10.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
function BackdropTransition(props) {
  return (0, import_jsx_runtime10.jsx)(Fade_default, {
    ...props
  });
}
var Offcanvas = React10.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const renderBackdrop = (0, import_react11.useCallback)((backdropProps) => (0, import_jsx_runtime10.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames5.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime10.jsx)("div", {
    ...dialogProps,
    ...props,
    className: (0, import_classnames5.default)(className, responsive ? `${bsPrefix}-${responsive}` : bsPrefix, `${bsPrefix}-${placement}`),
    "aria-labelledby": ariaLabelledby,
    children
  });
  return (0, import_jsx_runtime12.jsxs)(import_jsx_runtime11.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime10.jsx)(ModalContext_default.Provider, {
      value: modalContext,
      children: (0, import_jsx_runtime10.jsx)(Modal_default, {
        show: showOffcanvas,
        ref,
        backdrop,
        container,
...
//# sourceMappingURL=chunk-BGV7G5CK.js.map
